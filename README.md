...
- [ParlayAPI](https://github.com/JacobiusMakes/parlay-api-mcp) - Python stdio MCP server for sports odds, player props, public event discovery, and account usage; account data tools require each user's own API key and allowances. Run: `uvx --from parlayapi-mcp==0.3.6 parlayapi-mcp`.
