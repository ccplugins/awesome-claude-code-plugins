...
- [declaude](https://github.com/tenkenco/declaude) — Rewrites Claude-English into plain English: sycophantic openers, hedging filler and padded phrasing out; meaning, code blocks, names and numbers intact. Plugin ships a MessageDisplay hook plus a remote MCP server with OAuth sign-in (`https://speak-english.tenken.co/mcp`). Official registry `io.github.tenkenco/declaude`.
