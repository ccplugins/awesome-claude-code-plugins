...
### MCP Servers
- [Worklittle Jobs](https://github.com/worklittle/jobs-mcp) — Search over 4 million jobs with visa, salary, and distance filters. Remote MCP `https://mcp.worklittle.com/`. Official registry `io.github.worklittle/jobs`.
