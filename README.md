...
### Automation DevOps
- [claude-dash](https://github.com/krabat-l/claude-dash) - Real-time statusline plugin showing context health, quota, cost, cache efficiency, tool activity, and git status
