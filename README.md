...
- [sofagent](https://github.com/KongFangXun/sofagent) - External: FDE harness that audits AI coding agents at commit time — scans git diffs with 24 audit rules (secret leaks, out-of-scope edits, blind modifications without prior reads, commit-message prompt injection), writes HMAC-signed tamper-evident audit history, and ships MCP governance tools. MIT.
